<?php
	...
	if(!$_SESSION['user'] || $_SESSION['waktu']<time() || !$titleHTML) {
		...
		if($_GT['del']) {
			if($statHapusTrans==1 && getValue("1","t_panjar p","p.no_trans2='".$_GT['del']."' and p.no_trans3='' and tgl_trans2>'".$lastPosting."' limit 1")) {
				...
				*/
				...
				if(mysql_affected_rows()>0) {
					queryDb("update t_panjar set no_trans2='',no_bukti2='',keterangan2='',nominal2='0',tanggal2='".TANGGAL."',id_user2='".$_SESSION['user']."' where no_trans2='".$_GT['del']."' and tgl_trans2>'".$lastPosting."'");
				}
		...
		if($_PT['tSimpan']) {
			...
			$a=queryDb("select if(p.tgl_trans>'".balikTanggal($tTanggal)."',0,1) as stat_panjar_awal,p.nominal from t_panjar p
								 inner join t_glu u on u.id_gl4=p.id_gl4 and concat(u.id_unit1,'.',u.id_unit2,'.',u.id_unit3)='".$_SESSION['unit']."'
							where p.no_trans2='' and p.id_panjar='".$iPanjar."' limit 1");
			...
			if(!$errtTanggal && !$errtNoBukti && !$errnAkunD && !$errnAkunC && !$errnPanjar && !$errtBatas) {	
				...
				if($tId) {
					...
					queryDb("update t_panjar p
								...
								set p.id_unit1=u.id_unit1,p.id_unit2=u.id_unit2,p.id_unit3=u.id_unit3,tgl_trans2='".$tTanggal."',no_trans2='".$tIdTrans."',no_bukti2='".$tNoBukti."',keterangan2='".$tDesc."',nominal2='".clearRupiah($tNominal)."',tanggal2='".TANGGAL."',id_user2='".$_SESSION['user']."'
								where p.no_trans2='' and p.id_panjar='".$iPanjar."'");
              ...
              <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <input name="nPanjar" type="text" id="nPanjar" maxlength="200" value="<?=htmlentities($nPanjar)?>" autocomplete="off" onkeyup="goFramePopup(this,'Panjar','panjar');hideFade('errnPanjar');clearElmX();" onfocus="framePopupFocus('Panjar')" onblur="framePopupBlur('Panjar')" />
...
<div id="list">
	...
	$row=50;
	$page=8;
	$sql="SELECT x.tgl_trans,x.no_trans,x.no_bukti,x.keterangan,x.nominal,if(x.tgl_trans>'".$lastPosting."',if(j.no_trans3='',1,0),0) as stat_delete,j.no_trans as panjar,if(j.tgl_expired<'".TANGGAL."',1,0) as stat_expired,
					...
					inner join t_panjar j on j.no_trans2=x.no_trans
