...
<div id="titleBottom">
	<ol>
    	...
    	<li class="r" style="width:auto;">JENIS ASET :
        	<select name="tJenisAset" id="tJenisAset">
            	<option value="1">Aset Tetap</option>
            	<option value="2">Aset Sewa</option>
            	<option value="9">Aset Lain-lain</option>
            	<option value="0">Aset Tak Berwujud</option>
            </select>
			<select name="tHibah" id="tHibah" required="required" onchange="if(this.value==1) elm('tMasaSusut').value=0;hideFade('errtHibah');">
				<option value="-">- Semua -</option>
				<option value="0">Non Hibah</option>
...
<script language="javascript">
	...
	function viewLap() {
		...
		popUp('../popup/v_daftar_aset.php?unit='+bs64_e(units.join("#"))+'&periode1='+bs64_e(elm('tTanggal').value)+'&periode2='+bs64_e(elm('tTanggal2').value)+'&jenis='+bs64_e(elm('tJenisAset').value)+'&hibah='+bs64_e(elm('tHibah').value),1000,600,'x');
		return false;
	}
	...
	function viewLap2() {
		...
		if(windowPopUp['x']) windowPopUp['x'].close();
		popUp('../popup/tandatangan_lap.php?x=8&unit='+bs64_e(units.join("#"))+'&periode1='+bs64_e(elm('tTanggal').value)+'&periode2='+bs64_e(elm('tTanggal2').value)+'&jenis='+bs64_e(elm('tJenisAset').value)+'&hibah='+bs64_e(elm('tHibah').value),1000,600,'x');
		return false;
	}
