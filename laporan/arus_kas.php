...
<script language="javascript">
	...
	function viewLap() {
		...
		popUp('../popup/v_arus_kas'+((elm('tAwal').value)?"_komper":"")+((elm('tDetail').checked)?elm('tDetail').value:"")+'.php?unit='+bs64_e(units.join("#"))+'&awal='+bs64_e(elm('tAwal').value)+'&periode1='+bs64_e(elm('tTanggal').value)+'&periode2='+bs64_e(elm('tTanggal2').value),1000,600,'x');
		return false;
	}
	...
	function viewLap2() {
		...
		if(windowPopUp['x']) windowPopUp['x'].close();
		popUp('../popup/tandatangan_lap.php?x=6&unit='+bs64_e(units.join("#"))+'&awal='+bs64_e(elm('tAwal').value)+'&periode1='+bs64_e(elm('tTanggal').value)+'&periode2='+bs64_e(elm('tTanggal2').value),1000,600,'x');
		return false;
	}
