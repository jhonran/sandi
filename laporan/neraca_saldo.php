...
<script language="javascript">
	...
	setTanggal('','<?=date("1/1/Y")?>','<?=date("d/m/Y")?>');
	...
	function viewLap2() {
		...
		if(windowPopUp['x']) windowPopUp['x'].close();
		popUp('../popup/tandatangan_lap.php?x=3&unit='+bs64_e(units.join("#"))+'&periode1='+bs64_e(elm('tTanggal').value)+'&periode2='+bs64_e(elm('tTanggal2').value),1000,600,'x');
		return false;
	}
