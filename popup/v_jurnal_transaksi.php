...
<?php
$_GLX=array();
$a=queryDb("select id_gl4,nama from t_glu where concat(id_unit1,'.',id_unit2,'.',id_unit3)='".$_SESSION['unit']."' and id_gl1='3'");
...
$sql="SELECT t.tgl_trans,t.no_trans,t.keterangan,t.id_gl4,t.id_glx,ifnull(u.nama,'') as nama_gl,t.nominal_d,t.nominal_c,if(nominal_d>nominal_c,1,0) as sort_nominal
			...
			where concat(t.id_unit1,'.',t.id_unit2,'.',t.id_unit3) in ('".str_replace("#","','",$tUnit)."') and t.id_mtrans in ('".str_replace("#","','",$_GT['mutasi'])."') and t.no_trans_ref=t.no_trans and t.tgl_trans between '".balikTanggal($_GT['periode1'])." 00:00:00' and '".balikTanggal($_GT['periode2'])." 23:59:59'
