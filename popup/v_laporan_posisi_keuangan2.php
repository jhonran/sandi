...
if(getValue("1","t_posting","tgl_finish='".balikTanggal($_GT['periode'])."' limit 1")) {
	$sql="select u.id_gl1,u.id_gl2,u.id_gl3,u.id_gl4,g1.nama as nm1,g2.nama as nm2,g3.nama as nm3,u.nama as nm4,sum(saldo) as nilai from t_gluh u
						...
						group by u.id_gl1,u.id_gl2,u.id_gl3,u.id_gl4,nm1,nm2,nm3,nm4
						order by u.id_gl1,u.id_gl2,u.id_gl3,u.id_gl4";
	$valid="<div align='left'><i>Laporan Valid</i></div>";
}
else {
	$sql="select u.id_gl1,u.id_gl2,u.id_gl3,u.id_gl4,g1.nama as nm1,g2.nama as nm2,g3.nama as nm3,u.nama as nm4,sum((t.nominal_d-t.nominal_c)*if(g1.db_cr='D',1,-1)) as nilai from t_glu u
							inner join t_gl1 g1 on g1.id_gl1=u.id_gl1
							inner join t_gl2 g2 on g2.id_gl2=u.id_gl2
							inner join t_gl3 g3 on g3.id_gl3=u.id_gl3
...
while($b=mysql_fetch_array($a)) {
	...
	$_N4[$b['id_gl1']][$b['id_gl2']][$b['id_gl3']][$b['id_gl4']]=$b['nilai'];
}
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="nb">
            <tr>
              <td class="c" style="background:url(../images/logo_laporan<?=(file_exists("../images/logo_laporan_".$tUnit.".png"))?("_".$tUnit):""?>.png) no-repeat left center;padding-bottom:2em;vertical-align:middle;">
                ...
                <br /><strong>per <?=tglIndo(balikTanggal($_GT['periode']))?></strong>
              </td>
            </tr>
        </table>
    </td></tr>
    	...
    	<td style="width:50%">
			...
			if(is_array($_G2[1])) {
				...
				while(list($a,$b)=each($_G2[1])) {
					echo "<tr><td>&nbsp;<br /><strong>$b</strong></td><td>&nbsp;</td><td class='r'>&nbsp;<br /><strong>".numbAcc($_N2[1][$a])."</strong></td></tr>";
					reset($_G3);
					//reset($_N3);
					//reset($_M3);
					while(list($aa,$bb)=each($_G3[1][$a])) {
						echo "<tr><td>- &nbsp; $bb</td><td>&nbsp;</td><td class='r'>".numbAcc($_N3[1][$a][$aa])."</td></tr>";						
						reset($_G4);
						//reset($_N4);
						//reset($_M4);
						while(list($aaa,$bbb)=each($_G4[1][$a][$aa])) {
							echo "<tr><td> &nbsp;  &nbsp; - &nbsp; $bbb</td><td>&nbsp;</td><td class='r'>".numbAcc($_N4[1][$a][$aa][$aaa])."</td></tr>";
						}
					}
				}
				echo "<tr><td class='bg'><strong>Jumlah ".$_G1[1]."</strong></td><td class='bg'>&nbsp;</td><td class='r bg'><strong>".numbAcc($_N1[1])."</strong></td></tr>";
			}	            
			?>
             </table><br />&nbsp;
        </td>
    	<td style="width:50%">
			...
			if(is_array($_G2[2])) {
				...
				while(list($a,$b)=each($_G2[2])) {
					echo "<tr><td>&nbsp;<br /><strong>$b</strong></td><td>&nbsp;</td><td class='r'>&nbsp;<br /><strong>".numbAcc($_N2[2][$a])."</strong></td></tr>";
					reset($_G3);
					//reset($_N3);
					//reset($_M3);
					while(list($aa,$bb)=each($_G3[2][$a])) {
						echo "<tr><td>- &nbsp; $bb</td><td>&nbsp;</td><td class='r'>".numbAcc($_N3[2][$a][$aa])."</td></tr>";						
						reset($_G4);
						//reset($_N4);
						//reset($_M4);
						while(list($aaa,$bbb)=each($_G4[2][$a][$aa])) {
							echo "<tr><td> &nbsp;  &nbsp; - &nbsp; $bbb</td><td>&nbsp;</td><td class='r'>".numbAcc($_N4[2][$a][$aa][$aaa])."</td></tr>";
						}
					}
				}
				echo "<tr><td class='bg'><strong>Jumlah ".$_G1[2]."</strong></td><td class='bg'>&nbsp;</td><td class='r bg'><strong>".numbAcc($_N1[2])."</strong></td></tr>";
			}	            
			?>
			...
			if(is_array($_G2[3])) {
				...
				while(list($a,$b)=each($_G2[3])) {
					echo "<tr><td>&nbsp;<br /><strong>$b</strong></td><td>&nbsp;</td><td class='r'>&nbsp;<br /><strong>".numbAcc($_N2[3][$a])."</strong></td></tr>";
					reset($_G3);
					//reset($_N3);
					//reset($_M3);
					while(list($aa,$bb)=each($_G3[3][$a])) {
						echo "<tr><td>- &nbsp; $bb</td><td>&nbsp;</td><td class='r'>".numbAcc($_N3[3][$a][$aa])."</td></tr>";						
						reset($_G4);
						//reset($_N4);
						//reset($_M4);
						while(list($aaa,$bbb)=each($_G4[3][$a][$aa])) {
							echo "<tr><td> &nbsp;  &nbsp; - &nbsp; $bbb</td><td>&nbsp;</td><td class='r'>".numbAcc($_N4[3][$a][$aa][$aaa])."</td></tr>";
						}
					}
				}
				echo "<tr><td class='bg'><strong>Jumlah ".$_G1[3]."</strong></td><td class='bg'>&nbsp;</td><td class='r bg'><strong>".numbAcc($_N1[3])."</strong></td></tr>";
			}	            
			?>
             </table><br />&nbsp;
        </td>
    ...
    <tr>
    	<td>
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="nb">
            	<tr><td class='bg'><strong>Total <?=$_G1[1]?></strong></td><td class='bg'>&nbsp;</td><td class='r bg'><strong><?=numbAcc($_N1[1])?></strong></td></tr>
            </table>
        </td>
    	<td>
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="nb">
            	<tr><td class='bg'><strong>Total <?=$_G1[2]?> & <?=$_G1[3]?></strong></td><td class='bg'>&nbsp;</td><td class='r bg'><strong><?=numbAcc($_N1[2]+$_N1[3])?></strong></td></tr>
            </table>
        </td>
    </tr>
	<tr>
