...
<?php 
	$a=queryDb("select concat(u.id_unit1,'.',u.id_unit2,'.',u.id_unit3) as id_unit,concat('[',u.id_unit1,'.',u.id_unit2,'.',u.id_unit3,'] ', u.nama) as nm from t_unit3 u 
						where concat('[',u.id_unit1,'.',u.id_unit2,'.',u.id_unit3,'] ', u.nama) like '%".$_GT['s']."%' and concat(u.id_unit1,'.',u.id_unit2,'.',u.id_unit3) in ('".implode("','",array_keys($_UNITS))."')
								 ".(($_GT['q'])?("and (concat(u.id_unit1,'.',u.id_unit2,'.',u.id_unit3) like '".str_replace(",","%' or concat(u.id_unit1,'.',u.id_unit2,'.',u.id_unit3) like '",$_GT['q'])."%')"):"")."
