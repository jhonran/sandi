<?php
	...
	$titleHTML=getValue("s.judul","t_user u
											...
											inner join t_menu_sub s on s.id_menu_sub=h.id_menu_sub and s.status='1' and s.page='aset_berwujud.php'",
...
<div id="titleTop">
    ...
    <ol class="tab"><li>
    	<a href="aset_berwujud.php?edit=<?=bs64_e($_GT['id1'])."&hal=".bs64_e($_GT['hal'])."&sort=".bs64_e($_GT['sort'])."&search=".bs64_e($_GT['search'])."&order=".bs64_e($_GT['order1'])?>" class="on">ASET</a>
