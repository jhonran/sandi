...
<div id="titleTop">
    ...
    <ol class="tab"><li><a href="#">PILIH <?=strtoupper($_IST['kelas.php'])?></a><a href="#" class="off">JURNAL PENERIMAAN <?=strtoupper($_IST['siswa.php'])?></a></li></ol>
	<ol class="title">
    	<li>NO</li>
        <?php        
...
<div id="list">
	...
	$a=queryDb("select d.id_kelas,d.nama from t_kelas d
							inner join t_siswa_tagih m on m.id_kelas=d.id_kelas
	...
	while($b=mysql_fetch_array($a)) {
		$paging['start']++;
		echo "<ul id=\"".$b['id_kelas']."\" onclick=\"listFocus(this)\" ondblclick=\"_URI['id1']='".$b['id_kelas']."';_URI['order1']='".$_GT['order']."';goAddress('id1,order1','terima_siswa_detail.php')\"><li>".$paging['start'].".</li><li>".$b['id_kelas']."</li><li>".$b['nama']."</li></ul>";
